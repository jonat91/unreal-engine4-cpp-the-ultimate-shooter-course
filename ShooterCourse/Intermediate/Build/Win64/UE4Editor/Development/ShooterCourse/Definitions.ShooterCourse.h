...
#define UE_PROJECT_NAME ShooterCourse
#define UE_TARGET_NAME ShooterCourseEditor
#define UE_MODULE_NAME "ShooterCourse"
...
#define SHOOTERCOURSE_API DLLEXPORT
